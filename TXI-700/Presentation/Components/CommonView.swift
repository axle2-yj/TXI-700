...
struct CommonPrintFormatter {
    ...
    static func twoColAlignedRow(
        ...
        let l = col1.leftAlignedPrint(width: width8)
        let m = col2.rightAlignedPrint(width: width14)
        
        let rText = percent.percentTextOrEmpty()
        let r = rText.rightAlignedPrint(width: width8)
    ...
    static func threeColumnLine(_ col1: String, _ col2: String, _ col3: String) -> String {
        return
            col1.fitToPrintWidth(8) +
            col2.fitToPrintWidth(2) +
            col3.fitToPrintWidth(20)
    }
